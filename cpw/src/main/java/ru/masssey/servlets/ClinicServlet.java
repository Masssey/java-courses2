package ru.masssey.servlets;
import ru.masssey.veteinar.Dog;
import ru.masssey.veteinar.*;
import ru.masssey.veteinar.Pet;
...
//d
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if (!req.getParameter("name").isEmpty() )
            this.pets.add(new Cat( req.getParameter("name")));
        doGet(req, resp);
    }
    ...
    private String viewPets() {
        ...
        for (Pet pet : this.pets) {
            sb.append("<tr><td>").append(pet.getName()).append("</td><td>");
        }
        sb.append("</table>");
        return sb.toString();
    }
